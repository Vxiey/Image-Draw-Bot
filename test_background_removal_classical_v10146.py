...
class ClassicalBackgroundRemovalTests(unittest.TestCase):
    def test_plain_background_keeps_internal_matching_detail(self):
        ...
        self.assertEqual(result.metadata['method'], 'fast border-connected colour segmentation')
    ...
    def test_multicolour_background_uses_edge_aware_region_segmentation(self):
        ...
        # Strong subject contour and interior colour unrelated to the border.
        ...
        self.assertEqual(result.metadata['method'], 'edge-aware multi-colour border region segmentation')
        self.assertFalse(result.metadata['ai_used'])
